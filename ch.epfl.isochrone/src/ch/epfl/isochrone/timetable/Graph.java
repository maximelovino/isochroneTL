...
public final class Graph {
     ...
     * @return The fastest path from that stop 
     * 			at that time for all the other stops
     * @throws IllegalArgumentException
     *      If the startingStop is not in the set of stops 
     *      or if the departureTime is smaller than 0
     */
    ...
    public final static class Builder {
         ...
         * @throws IllegalArgumentException
         *      If the departure Stop or the arrival Stop are not contained 
         *      in the set of stops of the graph 
         *      OR if one of the time is negative 
         *      OR if the arrival time is inferior to the departure time 
         */
         ...
         *      The builder (this) so we can chain method calls
         * @throws IllegalArgumentException
         *      If the maximum walking time is negative 
         *      OR the walking speed is inferior or equal to 0
         */
        ...
        private GraphEdge.Builder obtainBuilder(Stop fromStop, Stop toStop) {
            ...
            //We are always sure to have a builder, because if  
            //it doesn't exist, we create one, and if it exists, we pick it
            return builder;
        }
